"""
Django settings for anishtestapp_1 project.
...
ROOT_URLCONF = 'anishtestapp_1.urls'
...
WSGI_APPLICATION = 'anishtestapp_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "anishtestapp Support <support@anishtestapp-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "anishtestapp_1 API",
    "DESCRIPTION": "API documentation for anishtestapp_1 App",
    "VERSION": "v1",
}
